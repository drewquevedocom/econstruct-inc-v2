      ...
      body: JSON.stringify({
        ...
        body: {
          html: `<div style="font-family:Arial,sans-serif;max-width:600px;color:#222;">
            ...
            <p style="color:#666;font-size:13px;">Instantly auto-blocklists this address -- they will not receive any further emails from us. View in <a href="https://econstructinc.com/crm/partners" style="color:#B8963E;">/crm/partners</a>.</p>
          </div>`,
        },
      }),
    });
