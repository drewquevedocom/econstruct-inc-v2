...
export default function BlogPostContent({ post, canonicalUrl }: BlogPostContentProps) {
  ...
  const breadcrumbSchema = generateBlogBreadcrumbSchema([
    ...
    { name: "Blog", url: "https://www.econstructinc.com/blog" },
    {
      name: post.category,
      url: `https://www.econstructinc.com/blog/category/${post.categorySlug}`,
    },
    { name: post.title, url: canonicalUrl },
  ]);

  const articleSchema = generateBlogArticleSchema(post, canonicalUrl);
