...
description: "A comprehensive guide to Conditional Use Permits (CUPs) in Los Angeles — what they are, when you need one, and how the application process works for commercial construction projects."
...
excerpt: "When you want to use a property for a purpose that differs from its zoning designation, you will likely need a Conditional Use Permit (CUP). This guide explains how CUPs work in Los Angeles and what to expect from the application process."
...
relatedSlugs:
  ...
  - "restaurant-construction-los-angeles-build-your-dream-eatery-with-econstruct"
